...
\htmladdnormallink{Parallel-NetCDF}{https://parallel-netcdf.github.io}.
...
\item[ESMF\_OPENMP]
Possible value: {\tt OMP4}, {\tt ON}, {\tt OFF} (default is system dependent)

Compiles and links the ESMF library with OpenMP compiler flags.
Both {\tt OMP4} and {\tt ON} enable the ESMF OpenMP features. Only with
{\tt OMP4} will those features assume OpenMP 4.0 and higher.
...
Environment variables must be set in the user's shell or when calling make. It
